...
message0= [' Now using pb0r as a reference. The results will differ by less',$
           ' than 0.1% in the radius, and comparably in other parameters.',$
           ' To get the old values set the keyword /old.',$
           ' To remove this message use /quiet.']

if ~keyword_set(quiet) then print,message0
