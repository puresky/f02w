...
function merge_struct,struct1,struct2,err=err,notag_check=notag_check,$
                nocheck=nocheck,_extra=extra,relaxed=relaxed,no_copy=no_copy
...
if since_version('5.3') then begin
 ...
 if keyword_set(no_copy) then $
  return,[temporary(struct1),temporary(temp2)] else $
   return,[struct1,temporary(temp2)]
endif
