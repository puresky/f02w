...
;    current time is within one week of the beginning of the year, write the previous 
...
; if writing archive and current time is within 7 days of beginning of year, write previous year too
...
for i=0,nyear-1 do begin
  ...
  a=g->get_gev()
  year=trim(ts[6])
  list = ['GOES XRAY events for ' + year, '(written ' + anytim(!stime,/date,/vms) + $
          ', Kim Tolbert, kim.tolbert@nasa.gov'+ ')', '', a]
