...
;rhost='hyperion.nascom.nasa.gov'
rhost='umbra.nascom.nasa.gov'
;if ~have_network(rhost) then if have_network(rhost_back) then rhost=rhost_back
...
eis_prep,file,_extra=extra,/default,/quiet
